    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>บันทึกข้อมูลโครงการจัดซื้อ</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="project_detail" class="form-control" id="project_detail">{{ $project->project_detail }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="project_company">บริษัทห้างร้านผู้จำหน่าย</label>
                                        <input type="text" name="project_company" class="form-control" id="project_company" value="{{ $project->project_company }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="project_company_contact">เบอร์โทรติดต่อ</label>
                                        <input type="text" name="project_company_contact" class="form-control" id="project_company_contact" value="{{ $project->project_company_contact }}" required>
                                    </div>
                                    <div class="form-group">
